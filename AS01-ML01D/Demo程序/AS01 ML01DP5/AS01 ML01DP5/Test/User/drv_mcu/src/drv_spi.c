...
//	
//	SPI_Init( SPI_PORT, &SpiInitStructer );		//初始化SPI
...
//	
	...
	HAL_SPI_TransmitReceive(&hspi2, &TxByte, &l_Data, 1, 1000);
	return l_Data;		//返回
}
...
{
	HAL_GPIO_WritePin( SPI_NSS_GPIO_PORT, SPI_NSS_GPIO_PIN, GPIO_PIN_RESET);			//拉低片选
//	__HAL_SPI_ENABLE(&hspi2);
	...
	HAL_GPIO_WritePin(SPI_NSS_GPIO_PORT, SPI_NSS_GPIO_PIN, GPIO_PIN_SET);			//拉高片选
